<!--
实现逻辑：
1. 承载新增 Agent 的弹框表单，复用共享 Agent 表单状态和保存逻辑。
2. 弹框只负责表单展示、Skills 绑定和保存触发，不承载 Agent 列表行为。
-->
      ...
      <div class="modal-scroll-body">
        ...
        <div class="agent-prompt-block">
          ...
          <div class="model-actions">
            <button class="primary" @click="saveAgent" :disabled="agentBusy">新增 Agent</button>
          </div>
        </div>
      </div>
    </section>
