...
import { deleteRawContent, importCollectorItem, loadCollectorSources, previewCollectorItems } from '../../api/client';
export function createCollectorContext(deps) {
    ...
    function rawContentSourceLabel(sourceKey) {
    ...
    function rawContentStatusLabel(status) {
        const labels = {
            collected: '已采集',
            pending: '待处理',
            generated: '已生成',
