...
export const navItems: Array<{ key: PageKey; label: string; description: string }> = [
...
export function createDashboardState(): DashboardPayload {
  return {
    accounts: [],
    rawContents: [],
    drafts: [],
...
export function createPaginationState(): Record<PaginationKey, { page: number; pageSize: number }> {
  return {
