...
import { createDashboardState, createPaginationState, navItems } from './context';
import { createPaginationHelpers, formatDate, metricText, platformLabel, priorityLabel, readableError } from './utils';
export function createWorkbench() {
    ...
    const { selectedRawContentIds, collectorSources, loadCollectors } = collectorContext;
    ...
    const { agentConfigs, loadAgents } = agentsContext;
    ...
    const { reviewForm, profileForm, loadReviewReports, clearProfileContext } = accountProfileContext;
    ...
    const { smartFilterAccountId, contentSelectionAgentId, clearSmartFilterAccount } = smartFilterContext;
